...
#### Yes, the threads are running concurrently, and there are synchronization errors.
#### Although the final value of the counter is correct, since the counter is being
#### written and read, the value being read isn't always the actual value of the
#### counter at that instance.
