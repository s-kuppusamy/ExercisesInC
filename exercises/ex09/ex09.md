...
It only runs for the first RSS feed, not the others, because as soon as you
call exec(), the original program ends immediately. Thus, it never goes back
to actually finish printing the rest. 
